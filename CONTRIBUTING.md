...
```
git clone git@github.com:UCL-CHME0039-24-25/<REPO_ID>.git
```
...
9.1 You can navigate branches in https://github.com/UCL-CHME0039-24-25/<REPO_ID>/branches and removed merged branches by clickling :wastebasket: icon.    
